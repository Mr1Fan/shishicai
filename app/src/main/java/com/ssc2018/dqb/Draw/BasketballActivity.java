...
class BasketballActivity extends Activity implements MyBaseExpandableAdapter.PageDelegate {
    ...
    public void initData() {
        Type types = new TypeToken<ResponseBaseResult<EverydayDataBean<BasketPlayBean>>>() {
        }.getType();
        String json = TempDataRead.getData(this, "basketball_data");
        Gson gson = new Gson();
        ResponseBaseResult<EverydayDataBean<BasketPlayBean>> response = gson.fromJson(json, types);
    ...
    public void findView() {
        ...
        findViewById(R.id.confirm_bet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToastUtils.show("根据相关法律法规，线上暂不允许购彩，请到各大线下网点投注", BasketballActivity.this);
            }
        });
        initData();
    }
    ...
    public Context getContext() {
        return BasketballActivity.this;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_basketball_ht, null);
